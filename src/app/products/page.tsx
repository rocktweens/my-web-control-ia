...
import ServiceCardView from "@/partials/ServiceCardView";
import ProductFilters from "@/partials/ProductFilters";
import ProductListView from "@/partials/ProductListView";
import ServiceListView from "@/partials/ServiceListView";
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 lg:col-9">
            {layout === "list" ? (
              <ServiceListView searchParams={searchParams} />
            ) : (
              <ServiceCardView searchParams={searchParams} />
            )}
          </div>
        </div>
      </div>

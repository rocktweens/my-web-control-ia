            ...
            >
              {abouts?.map((item: About, index: number) => (
                <div
                  id={item.slug ?? ""}
                  key={index}
                  className={`rounded-lg relative flex flex-col items-center px-7 py-10 dark:bg-darkmode-light`}
                >
                  ...
                  <div
                    className={`text-text-dark dark:text-white absolute top-[50%] opacity-25`}
                  >
                    <svg
                      width="160"
                      height="160"
